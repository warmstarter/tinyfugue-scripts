...
/set utilities_author=Galvin, Michael Hunger, Reasgan, TF mailing list
/set utilities_info=Common functions missing from main tf library 
/set utilities_url=
/set utilities_version=1.0.0

/require helplist.tf

/help_add /help_utilities Common functions missing from main tf library

/def -i help_utilities = \
  /echo -aB utilities help:%;\
